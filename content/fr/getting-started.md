...
### Utilisez les ontologies ouvertes

Le moyen le plus rapide de commencer. Récupérez les fichiers Turtle depuis GitHub, chargez-les dans votre triplestore.

1. [Parcourir les ontologies](https://github.com/iqns-org/ontologies)
2. Choisissez les domaines pertinents pour vous (IA, juridique, finance, santé, etc.)
3. Chargez dans n'importe quel magasin RDF (Apache Jena, Blazegraph, GraphDB, Stardog)
4. Interrogez avec SPARQL

Aucun compte requis. Aucun inscription.

---

### Connectez les agents IA via MCP
...
### Créez des bases de connaissances privées
...
- [Contactez‑nous](/contact) — partenariats, travaux sur mesure, questions

---

[Retour à l'accueil](/) · [Comment ça fonctionne](/how-it-works)
