...
addons:
  ...
  subheading: uniquement si vous avez besoin de services avancés
  items:
    - icon: ShieldCheck
  ...
  items:
    ...
    - q: Où mes données sont‑elles hébergées ?
      a: >-
        ...
        connaissances privées restent dans votre locataire. Nous ne mélangeons
        jamais les données des clients.
---
