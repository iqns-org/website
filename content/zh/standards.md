...
IQ:NS 并不优先采用单一套法规；它会从仓库中为每个情境挑选相关的本体模型。
...
- **覆盖范围：** 计划-执行-检查-行动（PDCA）管理体系、附录 A 控制、内部审计
...
| 概念 | 欧盟 AI 法案 | NIST AI 风险管理框架 | ISO 42001 |
|---|---|---|---|
| 风险管理 | 第 9 条 | Map 功能 | 第 6.1 条 |
| 人类监督 | 第 14 条 | Govern 1.4 | A.8.4 |
| 技术文档 | 第 11 条 | Map 3.4 | A.6.2 |
| 偏见与公平 | 第 10(2)(f) 条 | Measure 2.6 | A.10.3 |
| 透明度 | 第 IV 章 | Govern 4.1 | A.8.3 |
