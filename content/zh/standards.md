...
没有单一框架能覆盖所有内容。大多数组织面临来自多个标准的重叠要求——而它们之间的空白正是问题潜伏之处。

IQ:NS 将 `./ontologies/v1/` 中的 50 多个框架和领域模型建模为结构化本体。以下是它们覆盖的内容。
...
|---|---|---|
| SR 11-7 | 美国 | 模型风险管理 |
| EBA AI Guidelines | 欧盟 | 信用机构 AI 监督 |
| MAS AI Governance | 新加坡 | 金融机构 AI 治理 |

### 医疗保健
| 框架 | 司法管辖区 | 重点 |
|---|---|---|
| FDA AI/ML SaMD | 美国 | 临床 AI 与作为医疗器械的软件 |
| ONC Trustworthy AI | 美国 | 健康信息技术 AI 标准 |
...
IQ:NS 以结构化方式映射这些对应关系——因此您可以看到某一概念跨越多个标准的情况，以及真正的空白所在。

---

[了解本体如何工作](/how-it-works) · [在 GitHub 上探索](https://github.com/iqns-org/ontologies)
