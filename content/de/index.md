...
hero:
  ...
  cta:
    ...
    - title: Offene Ontologien
      link: /ontologies/index
    - title: GitHub
      link: 'https://github.com/iqns-org/ontologies'
value_props:
  heading: 'Was IQ:NS macht'
  subheading: Integration ist ein Sprachproblem. Ontologien lösen es. In großem Maßstab.
  items:
    - icon: ShieldCheck
    ...
    - icon: Users
      ...
      description: >-
        Die Kernontologien sind kostenlos und Open Source. Sie werden von
        Mitwirkenden erstellt, die Wert darauf legen, die Struktur richtig zu
        gestalten – nicht, Ihnen ein Dashboard zu verkaufen.
    - icon: Zap
    ...
    - icon: Network
      ...
      description: >-
        Organisationen wissen Dinge — Verpflichtungen, Risikotoleranzen,
        Betriebsregeln. IQ:NS verleiht diesem Wissen eine Struktur, die
        Rollenwechsel von Personen übersteht.
    - icon: BarChart
...
industries:
  heading: 20+ Domänen. Eine gemeinsame Struktur.
  items:
    - icon: Brain
    ...
    - icon: Building
      ...
      description: >-
        Basel III, DORA, MiFID II, SOX, SR 11-7, EBA — Modellrisiko und
    ...
    - icon: Globe
      title: Regierung
      description: >-
        FedRAMP, NIST CSF, ISO 38500 — Rechenschaftspflicht im öffentlichen
        Sektor.
    - icon: Shield
      title: Verteidigung
      description: >-
        DoD RAI Principles, NATO AI Principles — verantwortungsvolle KI in der
        Verteidigung.
    - icon: Briefcase
      title: Unternehmen
      description: >-
        COBIT, ISO 27001, ISO 31000, ISO 45001, SOC 2 — Unternehmensrisiken und
        Sicherheit.
    - icon: GraduationCap
      title: Bildung
    ...
    - icon: Zap
      title: Energie
      description: ISO 50001 — Energiemanagement und KI‑Integration.
    - icon: ShieldCheck
      title: Versicherung
    ...
    - icon: Car
      title: Transport
      description: UN R157 — autonome Fahrzeuge und automatisiertes Fahren.
    - icon: Server
      title: SaaS & SKMS
      description: 'Service‑Wissensmanagement für AWS, Azure, GCP, DigitalOcean.'
    - icon: Rocket
      title: Startups
