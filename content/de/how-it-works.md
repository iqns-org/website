...
description: >-
  ...
  Ontologien verwandelt, die AI agents und Teams nutzen können.
lang: de
navigation:
  section: platform
  label: howItWorks
...
Standards, Vorschriften und institutionelle Regeln liegen als natürliche Sprache in PDFs vor. Sie sind nützlich, wenn Menschen sie von Anfang bis Ende lesen — weniger nützlich, wenn eine Maschine darüber nachdenken soll, wie Artikel 13 des EU‑KI‑Gesetzes zu einer NIST‑Kontrolle oder einer ISO‑Klausel in Beziehung steht.

IQ:NS modelliert diese Konzepte als formale Ontologien — strukturierte Vokabulare, bei denen jeder Begriff eine stabile Kennung, eine Definition, die in seiner Quelle verankert ist, und explizite Beziehungen zu verwandten Konzepten über verschiedene Rahmenwerke hinweg besitzt.

## Die vier Ebenen

### 1. Konzeptmodellierung

Jeder Standard wird in seine Bestandteile zerlegt — Verpflichtungen, Kontrollen, Risikokategorien, Rollen — und als OWL‑Klassen mit SKOS‑Bezeichnungen und Definitionen dargestellt. Jeder Begriff lässt sich auf seine maßgebliche Quelle zurückführen.

### 2. Framework‑übergreifende Ausrichtung
...
- **Via SPARQL abfragen** — programmatisch Fragen über Rahmenwerke hinweg stellen  
- **Via MCP verbinden** — Ihren KI‑Agenten ermöglichen, direkt über institutionelles Wissen zu schließen  
- **Mit Tools integrieren** — in GRC‑Plattformen, Datenkataloge, CI/CD‑Pipelines einbinden  
...
- Keine GRC‑Plattform — es führt keine Workflows oder Genehmigungen aus  
- Keine Beratung — Sie treffen die Entscheidungen; die Ontologien liefern die Struktur  

IQ:NS ist die **semantische Grundlage**, auf der diese Systeme aufbauen können.
