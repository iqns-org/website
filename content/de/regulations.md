...
IQ:NS modelliert über 50 Rahmenwerke als strukturierte Ontologien. Das ist, was sie abdecken.
...
- **Durchsetzung:** Geldstrafen von bis zu 7 % des globalen Umsatzes
...
- **Warum es wichtig ist:** Das am operativ umsetzbarste verfügbare Rahmenwerk
...
| EBA AI Guidelines | EU | KI‑Aufsicht von Kreditinstituten |
| MAS AI Governance | Singapore | KI‑Governance von Finanzinstituten |

### Gesundheitswesen
| Rahmenwerk | Jurisdiktion | Fokus |
|---|---|---|
| FDA AI/ML SaMD | US | Klinische KI und Software als Medizinprodukt |
| ONC Trustworthy AI | US | KI‑Standards für Gesundheits‑IT |

### Sicherheit
| Rahmenwerk | Fokus |
|---|---|
| OWASP LLM Top 10 | Sicherheitslücken von LLM |
...
[Sehen Sie, wie die Ontologien funktionieren](/how-it-works) · [Auf GitHub erkunden](https://github.com/iqns-org/ontologies)
