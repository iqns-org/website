...
description: 'Como o IQ:NS lida com suas informações.'
lang: pt
navigation:
  section: platform
  label: Privacidade
...
- Você pode optar por não fornecer informações pessoais ao nos contatar, embora isso possa limitar nossa capacidade de responder.  
- As configurações do navegador podem permitir que você rejeite cookies ou limpe o armazenamento local, mas alguns recursos do site podem exigir cookies para funcionar corretamente.

## Alterações nesta política

Podemos atualizar esta política de tempos em tempos. Quando o fizermos, publicaremos a versão atualizada nesta página com uma data de vigência revisada.

## Contato

Se você tiver dúvidas sobre esta política ou quiser exercer seus direitos de dados, entre em contato conosco através do formulário de contato do site.
