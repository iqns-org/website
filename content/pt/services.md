...
plans:
  - id: community
    ...
    annual:
      ...
      period: /year
    features:
      - Mais de 100 Ontologias Abertas
      - Suporte da Comunidade
      - Padrões da Indústria
      - 'RDFS, OWL, SKOS, SHACL'
      - Integrações Ilimitadas
    cta: Explorar no GitHub
    highlight: true
...
addons:
  ...
  subheading: apenas se precisar de serviços avançados
  items:
    - icon: ShieldCheck
  ...
  items:
    ...
    - q: Onde meus dados são hospedados?
      a: >-
        ...
        escolhe a região. Bases de conhecimento privadas permanecem no seu
        tenant. Nunca misturamos dados de clientes.
---
