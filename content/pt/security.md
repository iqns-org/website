...
- Seus perfis de sistema (se usar o nível comercial): nomes, capacidades, classificações de risco
- Suas extensões de ontologia (se privadas): conceitos e mapeamentos personalizados
...
- **Isolado (air-gapped)** — totalmente on-premises para ambientes regulados

## Conformidade

- Auditado SOC 2 Tipo II
- Conforme GDPR — sem retenção de dados pessoais
