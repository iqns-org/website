...
IQ:NS es un proyecto de código abierto que convierte el conocimiento institucional fragmentado, los marcos y las reglas operativas en ontologías estructuradas y consultables. Construidas sobre estándares de la web semántica (RDF, SKOS, OWL, SHACL), las ontologías proporcionan a los sistemas de IA y a las organizaciones un lenguaje compartido.

## Por qué existe

La integración de IA en las organizaciones es fundamentalmente un **problema de lenguaje**. Los equipos leen los mismos estándares y políticas y llegan a conclusiones diferentes. Las reglas usan términos distintos para los mismos conceptos. El conocimiento institucional vive en documentos que las máquinas no pueden razonar.
