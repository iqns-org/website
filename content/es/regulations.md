...
description: >-
  Los modelos IQ:NS de IA y estándares organizacionales — lo que cubren, a
...
IQ:NS modela más de 50 marcos como ontologías estructuradas. Esto es lo que cubren.
...
- **Cubre:** Sistema de gestión plan‑do‑check‑act, controles del Anexo A, auditoría interna
...
|---|---|---|
| SR 11-7 | EE. UU. | Gestión de riesgo de modelos |
| Directrices de IA del EBA | UE | Supervisión de IA en instituciones de crédito |
| Gobernanza de IA del MAS | Singapur | Gobernanza de IA en instituciones financieras |
...
| Marco | Enfoque |
|---|---|
| OWASP LLM Top 10 | Vulnerabilidades de seguridad en LLM |
...
IQ:NS mapea estas intersecciones estructuralmente — de modo que puedes ver dónde un concepto abarca múltiples normas y dónde existen brechas reales.
